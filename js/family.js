...
window.createFamilyGoal = function() {
    ...
    const amount =
        Number(
            document
            .getElementById("familyGoalAmount")
            .value
        );
...
window.removeFromFamilyGoal = function(id) {
...
window.deleteFamilyGoal = function(id) {
...
<p>
💰 Saved:
$${Number(member.saved || 0).toFixed(2)}
</p>
